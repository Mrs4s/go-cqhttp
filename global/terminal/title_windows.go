...
// SetTitleWithUin Windows 设置标题为QQ号 -  go-cqhttp `版本` `版权`
func SetTitleWithUin() error {
	return setConsoleTitle(fmt.Sprintf("%d - go-cqhttp "+base.Version+" © 2020 - %d Mrs4s", base.Account.Uin, time.Now().Year()))
}
